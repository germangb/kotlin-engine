...
abstract class GLGraphicsState : GraphicsDevice {
    ...
    override fun polygonMode(mode: DrawMode) = glPolygonMode(GL_FRONT_AND_BACK, mode.glEnum)
    ...
    override fun depthTest(func: TestFunction) = if (func == TestFunction.DISABLED) {
